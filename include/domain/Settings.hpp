...
namespace CE::Domain
{
    struct Settings
    {
        ...
        unsigned short height_cm            = 130u;             //Water tank height, max distance to measure
        ...
        //Measure delays
        unsigned short radarDelay_s         = 10u;              //Delay between distance measures
        unsigned short weatherDelay_s       = 60u;              //Delay between weather updates
        unsigned short medianWindow         = 5u;               //Number of measures to median

        // Watchdog settings
        unsigned short watchdogCheckInterval_s  = 120u;     //Delay between health checks
        ...
        // Security Settings
        unsigned short pumpMaxTimeOn_m          = 20u;      //Max time in minutes Pump can be On
        unsigned short pumpCooldownTime_m       = 60u;      //Time in minutes Pump needs to cool down after a max Time On triggered.
    };
